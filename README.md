...
* **Desenvolvedor cabaço**: É aquele que acaba de entrar no universo das computarias. O desenvolvedor cabaço acredita em tudo o que é dito nas palestras e eventos de tecnologia. É aquele que fica animado em comprar e montar sua barraquinha da Campus Party para socializar, fazer network e adquirir experiências acreditando fielmente em tudo que é transmitido no evento. O Desenvolvedor cabaço tem um péssimo hábito de não dar a devida importância aos conselhos dos que estão por perto. Ao invés, ele prefere creditar no que vem de fora.

Além disso o desenvolvedor cabaço adora se apegar a modinhas. Não importa o impacto, não importa se um determinado framework tem a arquitetura cagada. Se está na boca do povo e principalmente sendo fomentado pelos mais diversos palestrantes, logo, automaticamente se torna uma verdade absoluta e tem que ser usado e fomentado. O desenvolvedor cabaço é o rei do Git. Afinal, ele sempre estará no ranking 1 no **[Git Blame](https://imasters.com.br/desenvolvimento/dica-git-da-semana-usando-blame)**.
...
* **Engomado cenourinha**: O engomado cenourinha só precisa de um incentivo para ficar feliz e fazer o trabalho. O chefe monta nas costas do cenourinha com uma vara de pescar e coloca uma cenoura a sua frente como se ele fosse um coelhinho. O engomado cenourinha também pode ser comparado a uma cabaça: **Faz barulho mas é oco por dentro**. 


Isto é, o cenourinha adora mesclar palavras em inglês com português e usar termologias difíceis como forma de se mostrar intelectualmente elevado perante os plebes. O problema é que na maior parte das vezes este tipo de engomado não faz a mínima ideia do que está falando. Seus argumentos costumam não haver consistência alguma. Basta um para questionar seus argumentos para que este engomado comece ou a mudar de assunto, gaguejar, ou até a admitir que não sabe. Mas não pense que isto é uma demonstração de humildade. Não caros leitores, isto é a demonstração que o poço sempre pode ser mais fundo do que a gente imagina. 
...
A prova cabal de que **o Deus Scrum não existe** é quando você precisa de "tempo ocioso" para aprimorar alguma técnica, código, fazer code review, e\ou refactoring. Se o SCRUM for consultado, logo, veremos que nada disso será possível. Logo, todos que cultuam o Deus Scrum estão errados! O SCRUM crucialmente irá falhar em outros momentos como quando a comunicação não for suficiente, quando o PO não encontra o cliente, quando o time não é o seu próprio gerente, quando reunião vira sinônimo de rito. 

O marreteiro sempre irá questionar a necessidades de ritos e metologias sistemáticas impostas ao fluxo de trabalho. O que afinal faz sentido? 
